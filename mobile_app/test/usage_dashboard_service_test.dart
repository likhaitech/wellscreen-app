...
void main() {
  group('UsageDashboardService', () {
    test(
      'returns cached report and intervention when permission is missing',
      () async {
        ...
        expect(result.interventionRecommendation, isNotNull);
        expect(
          result.interventionRecommendation?.type,
          InterventionType.appLimit,
        );
    ...
    test(
      ...
      () async {
        ...
        expect(result.interventionRecommendation, isNull);
        expect(
          result.errorMessage,
    ...
    test(
      'returns live report and intervention when permission is granted',
      () async {
    ...
    test(
      'returns cached report and intervention when live usage tracking fails',
      () async {
        final cachedReport = UsageReport(
